...
contract ContainerV2 is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public containerSupply = 4444;
    uint256 public contentSupply = 8888;
    ...
    modifier supplyLimit(uint256 _quantity, uint256 _reserved) {
        require(
            totalSupply() + _quantity + _reserved <= containerSupply,
